    ...
    <section class="recent-section">
      ...
      <div v-if="recentImages.length > 0" class="recent-grid grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
        <div 
          ...
          :key="image.id"
          class="recent-item rounded-lg overflow-hidden bg-light-100 dark:bg-dark-100 transition-all duration-300 hover:shadow-md dark:hover:shadow-dark-md group relative"
        >
          <!-- 图片区域 -->
